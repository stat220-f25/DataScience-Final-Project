...
full_data <- full_join(joined_sleep_factors, avg_students, by = join_by(sleep_hours)) |> drop_na()
...
ggplot(full_data, aes(x = sleep_hours, y = avg_performance)) +
  geom_point() +
  geom_line() +
  theme_minimal() +
  labs(
...
ggplot(full_data, aes(x = sleep_hours, y = avg_previous_score)) +
  geom_point() +
  geom_line() +
  theme_minimal() +
  labs(
...
ggplot(full_data, aes(x = sleep_hours, y = avg_hours_studied)) +
  geom_point() +
  geom_line() +
  theme_minimal() +
  labs(
...
ggplot(full_data, aes(x = sleep_hours, y = avg_score)) +
  geom_point() +
  geom_line() +
  theme_minimal() +
  labs(
...
ggplot(full_data, aes(x = sleep_hours, y = avg_sleep_quality)) +
  geom_point() +
  geom_line() +
  theme_minimal() +
  labs(
...
ggplot(full_data, aes(x = sleep_hours, y = avg_stress_level)) +
  geom_point() +
  geom_line() +
  theme_minimal() +
  labs(
